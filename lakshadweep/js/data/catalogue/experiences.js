...
export const EXPERIENCES = [
  ...
  exp('kayak', 'Lagoon kayak / canoe', 'kayak', ['Agatti', 'Kavaratti', 'Kalpeni', 'Minicoy'], '30–60 min · mornings are calmest', { key: 'kayak' }),
  exp('snorkel', 'Coral-garden snorkel', 'snorkel', ['Agatti', 'Kavaratti', 'Kalpeni'], 'Shallow lagoon · turtles likely', { key: 'snorkel' }),
  ...
  exp('tuna', 'Malabar-style tuna dinner', 'meal', ['Agatti', 'Kavaratti', 'Minicoy'], 'Mas tuna, fish curry · at dinner', { on: true, source: 'agattiEats', note: 'Inside the meal budget; no extra cost' }),
];
