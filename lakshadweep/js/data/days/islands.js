...
export const ISLAND_BLOCKS = {
  ...
  toKavaratti: {
    icon: 'boat', place: 'Agatti → Kavaratti', nav: 'Kavaratti', photo: 'boat', base: 'Kavaratti', at: 'Kavaratti', cap: 2,
  ...
  kavaratti: {
    ...
    fixed: [{ ic: 'wave', t: 'Govt Water Sports Centre: cheapest in the islands' }],
    meals: { b: 'homestay', l: 'kavarattiHotel', d: 'homestay' },
    stay: 'kavarattiHome',
    spend: [],
  },
  vesselBackAgatti: {
    icon: 'boat', place: 'Kavaratti → Agatti', nav: 'Agatti', photo: 'boat', base: 'Agatti', at: 'Agatti', cap: 1,
