 ...
 * The 100 is fixed by definition; the marketplace rows below keep their own evidence scores (verified specs, protections, maker, buyers).
 */
        ...
        {market.status !== 'not-found' ? (
          <>
            <p className="min-w-[16rem] flex-1">
              ...
              <span className="text-[var(--fg-dim)]"> · {EVIDENCE_META[market.ev].label}{market.ev !== 'official' ? ' — the 100 is the product; the listing score is only what its page proves.' : ''}</span>
            </p>
