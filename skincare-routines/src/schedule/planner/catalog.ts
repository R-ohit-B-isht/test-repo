...
export const CATALOG: CatalogItem[] = [
  ...
  face({ key: 'panthenol', label: 'Panthenol (B5)', aliases: ['panthenol', 'pantenol', 'panthanol', 'b5', 'd-panthenol'], role: 'hydrate', family: 'barrier', categories: ['calmserum'], tags: ['ing:panthenol', 'ing:vitamin-b5-panthenol'], slots: ['pm', 'am'], days: 7, priority: 1, ingredientOnly: true }),
