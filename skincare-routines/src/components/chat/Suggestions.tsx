...
export function Suggestions({ items, onPick, manifest }: Props) {
  return (
    <div className="flex h-full flex-col">
      ...
      <h2 className="mt-4 text-[22px] font-extrabold leading-tight tracking-tight text-display">Ask anything the site can prove.</h2>
      <p className="mt-2 text-[13.5px] leading-relaxed text-secondary">
        ...
        Ranks, scores and INCI provenance come from the site’s tools; nothing is guessed, and missing evidence is said out loud.
      </p>
      {items.length > 0 && (
