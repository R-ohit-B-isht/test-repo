...
function filteredPacks() {
  return DETANS
    ...
    .filter((s) => {
      ...
      if (state.type === "pack") return s.filters.format === "Pack";
      if (state.type === "scrub") return s.filters.format === "Scrub";
      if (state.type === "cream") return s.filters.format === "Cream / lotion";
      if (state.type === "mask") return s.filters.format === "Mask";
      if (state.type === "kit") return s.filters.format === "Kit / combo";
      if (state.type === "wash") return s.filters.format === "Wash / cleanser";
      if (state.type === "coffee") return s.filters.coffee;
      if (state.type === "ubtan") return s.filters.ubtan;
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  document.getElementById("heroCount").textContent = DETANS.length.toLocaleString("en-IN");
  initDevMode();
  render();
});
